...
function displayError(error, loc, offset) {
	...
	link.rel = "stylesheet";
	link.type = "text/css";
	link.href = chrome.runtime.getURL("assets/content_error.css");
	...
	imgError.src = chrome.runtime.getURL("assets/error.gif");
...
function displayUI(theme, html) {
	...
	content += '<link rel="stylesheet" type="text/css" href="' + chrome.runtime.getURL("assets/jsonview-core.css") + '">';
